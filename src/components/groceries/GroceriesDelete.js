...
import { fetchGrocieries, deleteGrocieries } from '../../actions';

class GroceriesDelete extends React.Component {
    componentDidMount() {
        this.props.fetchGrocieries(this.props.match.params.id);
    }
    ...
    renderActions() {
        ...
        return (
            <React.Fragment>
                <button onClick={() => this.props.deleteGrocieries(id)} className="ui button negative">Delete</button> 
...
export default connect(mapStateToProps, {fetchGrocieries, deleteGrocieries})(GroceriesDelete);